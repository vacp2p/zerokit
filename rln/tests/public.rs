...
mod test {
    ...
    fn test_groth16_proof_hardcoded() {
        ...
        let valid_snarkjs_proof = json!({
         "pi_a": [
          "17060709949805067355191281911046619529051647830797726469020712569043394113681",
          "18182483257861924980497750546232100752958227046655693500918767512750573146753",
          "1"
         ],
         "pi_b": [
          [
           "20267912492679900276473905352851433614545759993994562452503279543313420780996",
           "3526252439404283627872611732291805695350986543722675499035891473965946958317"
          ],
          [
           "6765248229860240034673849560689960095368427446341193261706827323987757202151",
           "10162506956668707812872314400126758716396489798692733660971686098317365859347"
          ],
          [
           "1",
           "0"
         ...
         "pi_c": [
          "21297385393586629643772191935751015461553214467301459013227501453567107644477",
          "7209127239249722183687361017017843264127817174921865276948942001061372512445",
          "1"
         ],
         "protocol": "groth16",
         "curve": "bn128"
        ...
        #[cfg(feature = "multi-message-id")]
        let x = str_to_fr(
            "13457151990942512614860633993431231434760293151836872908309532265784886493503",
            10,
        )
        .unwrap();
        ...
        let valid_proof_values = RLNProofValues::new(
            str_to_fr(
                "17776010223634961169157199952048269505200564238427524324975213232099251414114",
                10,
            )
            .unwrap(),
            x,
            str_to_fr(
                "3924991408327715903965968479677221177085620625610237299018081872831763860745",
                10,
            )
            .unwrap(),
            vec![
                str_to_fr(
                    "12738342361445671424545273615343507442689999795357962845910429304128355770282",
                    10,
                )
                .unwrap(),
                Fr::from(0),
            ...
            vec![
                str_to_fr(
                    "19008393957165979401039101347311903781726762612909968598506355446510816902247",
                    10,
                )
                .unwrap(),
                Fr::from(0),
