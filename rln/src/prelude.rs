...
pub use crate::{
    ...
    protocol::{
        bytes_be_to_rln_partial_witness, bytes_be_to_rln_proof, bytes_be_to_rln_proof_values,
        bytes_be_to_rln_witness, bytes_le_to_rln_partial_proof, bytes_le_to_rln_partial_witness,
        bytes_le_to_rln_proof, bytes_le_to_rln_proof_values, bytes_le_to_rln_witness,
        extended_keygen, extended_seeded_keygen, finish_zk_proof, finish_zk_proof_with_rs,
        generate_partial_zk_proof, generate_zk_proof_with_rs, generate_zk_proof_with_witness,
        keygen, proof_values_from_witness, recover_id_secret, rln_partial_proof_to_bytes_le,
